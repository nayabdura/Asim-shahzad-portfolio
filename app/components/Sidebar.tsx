...
// --- 1. Memoized Sidebar Item (Prevents unnecessary re-renders) ---
const SidebarItem = memo(({ 
  ...
  return (
    <div
      ...
      className="group relative flex items-center cursor-pointer py-1 transform transition-transform duration-300 hover:translate-x-1"
    >
      {/* Active Indicator Dot (Only JS animation needed) */}
      {isActive && (
        <motion.span
          layoutId="activeDot"
  ...
  return (
    <aside className="z-20 flex h-full w-64 flex-col justify-between border-r border-gray-100 bg-white/80 backdrop-blur-md px-6 py-8">
      ...
      <div className="mb-8 flex items-center gap-3 px-2">
        <div className="relative h-10 w-10 overflow-hidden rounded-full border-2 border-cyan-100 shadow-sm shrink-0">
          <Image 
            src={logo}
            alt="Asim SEO Logo"
            fill
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-gray-900 to-gray-800 p-5 shadow-lg text-white">
          ...
          <div className="relative z-10">
            ...
            <div className="flex items-center gap-3">
              <a 
                href="https://www.linkedin.com/in/asim-shahzad-seo-linkbuilding/" 
                target="_blank"
                rel="noopener noreferrer"
                aria-label="LinkedIn"
                className="p-1.5 rounded-lg bg-white/10 hover:bg-cyan-500 transition-colors text-white"
              >
                <Linkedin size={14} />
              </a>
              <a 
                href="https://www.instagram.com/backlinks.asim/" 
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a 
                href="mailto:asimseoweb@gmail.com" 
                className="ml-auto flex items-center gap-1 text-[10px] font-bold hover:text-cyan-400 transition-colors"
              >
...
// Memoize the entire Sidebar so it doesn't re-render if parent props unrelated to it change
